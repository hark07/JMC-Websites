        ...
        >
          ...
          <div className="flex justify-between items-start border-b p-6">
            ...
            <div className="flex-1 text-center">
              <h1 className="text-5xl font-extrabold text-black uppercase">
                Tribhuvan University
              </h1>

              <h2 className="text-4xl font-bold uppercase mt-2 text-black">
                Janjyoti Multiple Campus
              </h2>

              <h3 className="text-2xl font-bold uppercase mt-2">
            ...
            <div className="w-40">
              <label htmlFor="studentPhoto" className="cursor-pointer">
                <div className="border-2 h-52 flex items-center justify-center overflow-hidden">
                  {studentPreview ? (
                    <img
                      src={studentPreview}
                      alt="Student"
